...
<head>
    ...
    var upload_notification = "<div class='row'><div class='col-lg-12'><div class='alert alert-danger fade in' role='alert' ><p>This event doesn't have the required forms.</p></div></div></div>";
    var upload_table = "<div class='table-responsive table-bordered' id='forms_table'><table class='table' style='margin-bottom:0;'><tbody><tr id='COI_row'><td><div class='text-center'>CCS Conflict of Interest Form</div></td><td><div id='COI'>Upload</div></td></tr><tr id='honorarium_row'><td><div class='text-center'>CCS Honorarium Form</div></td><td><div id='honorarium'>Upload</div></td></tr><tr id='signin_row'><td><div class='text-center'>Sign In Sheet</div></td><td><div id='signin'>Upload</div></td></tr><tr id='evaluation_row'><td><div class='text-center'>Evaluation Form</div></td><td><div id='evaluation'>Upload</div></td></tr></tbody></table></div>";
    </script>
</head>
                                    ...
                                    <div class="col-lg-11 col-md-12">
                                        <form id="event_form" enctype="multipart/form-data" name="event_form" method="post" action="" role="form">
                                            <fieldset disabled>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                       <h2 style="margin-top:-10px;"> <small>Organized by:</small> </h2>
                                                    </div>
                                                    <div class="panel-body">
                                                        <label >Name: <?php echo $myevent->event_info[19]; ?></label><br>
                                                        <label>Company: <?php echo $myevent->event_info[20]; ?></label><br>
                                                        <label>Email address: <?php echo $myevent->event_info[21]; ?></label><br>
                                                        <label>Phone number: <?php echo $myevent->event_info[22]; ?></label><br>
                                                    </div>
                                                </div> 
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="col-xs-9 col-xs-offset-3">
                                                            <div class="form-group required">
                                                                ...
                                                                <input type="text" class="form-control" id="program_start_time" name="program_start_time" placeholder="00:00 am" data-error="Program start time required" required value="<?php echo $myevent->event_info[23]; ?>">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                        </div>
                                                            ...
                                                            <div class="col-xs-9 col-xs-offset-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-6">
                                                                        <div class="form-group">
                                                                            <label>Fax:</label>
                                                                            <input type="text" class="form-control" id="moderator_fax" name="moderator_fax" data-error="moderator's fax number required" value="<?php echo $myevent->event_info[17]; ?>">
                                                                            <div class="help-block with-errors"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
