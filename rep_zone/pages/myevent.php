                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-xs-9 col-xs-offset-3">
                                                            <div class="form-group required">
                                                                ...
                                                                <input type="text" class="form-control" id="qa_time" name="qa_time" placeholder="00:00 am" data-error="Discussion time required" required value="<?php echo $myevent->event_info[5]; ?>">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div> 
                                                    </div>
