...
class UpdateEvent
{
    ...
    private function updateAgenda()
    {
        ...
        $update_query = "UPDATE agendas SET arrrival_meal_time = TIME( STR_TO_DATE( :arrrival_time, '%h:%i %p' ) ), QA_time = TIME( STR_TO_DATE( :qa_time, '%h:%i %p' ) ), program_end_time = TIME( STR_TO_DATE( :end_time, '%h:%i %p' ) )
