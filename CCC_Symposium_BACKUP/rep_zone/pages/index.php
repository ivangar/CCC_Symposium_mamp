                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="agenda">
                            ...
                            <ul>
                                <li>Arrivals, sign-in and meal served: 10 minutes</li>
                                <li>Video presentation(s): 30 minutes</li>
                                <li>Moderated discussion: 15 minutes</li>
                                <li>Reflection, additional Q&A, evaluations: 5 minutes</li>
                            </ul>
                        </div>
                    </div>                 
                </div> 
